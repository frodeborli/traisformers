...
### Important Note
The code in this repo originates from [TrAISformer](https://github.com/CIA-Oceanix/TrAISformer), and is only slightly modified for our custom dataset. Our dataset is located in the `data/` directory, and must be decompress before the model can be trained on it.
